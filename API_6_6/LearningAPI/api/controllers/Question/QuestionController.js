...
module.exports = {
    ...
    update: (req, res) => {
        const request = new sql.Request()
            ...
            .query('UPDATE Course SET ExerciseID = @ExerciseID, QuestionContent = @QuestionContent, QuestionType = @QuestionType,QuestionTime = @QuestionTime,AnswerID = @AnswerID,Score = @Score WHERE QuestionID = @QuestionID', (err, result) => {
                if (err)
                    console.log(err);
    ...
    store: (req, res) => {
        ...
        form.parse(req, function (err, fields, files) {
            ...
            const request = new sql.Request()
                .input('ExerciseID', sql.NChar, fields.ExerciseID)
                .input('QuestionContent', sql.NVarChar, fields.QuestionContent)
                .input('QuestionType', sql.Int, fields.QuestionType)
                .input('QuestionTime', sql.Int, fields.QuestionTime)
                .input('AnswerID', sql.NChar, fields.AnswerID)
                .input('Score', sql.Int, fields.Score)
