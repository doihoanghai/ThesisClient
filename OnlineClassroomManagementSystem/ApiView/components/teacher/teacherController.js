(function (app) {
    ...
    teacherController.$inject = ['$state', 'authData', 'loginService', '$scope', 'authenticationService', '$ngBootbox', 'apiService', 'notificationService'];
    ...
    function teacherController($state, authData, loginService, $scope, authenticationService, $ngBootbox, apiService, notificationService) {
        $scope.CurQuestion = {};
        $scope.cauhoi = {};
        $scope.updateModal = {};
        $scope.updateAnswer = {};
        ...
        $scope.val = function () {
            ...
            //GET ANSWER EACH
            $scope.answerData = [];
            apiService.get('StudentAnswer/' + $scope.curDataFilter[$scope.qIndex].QuestionID, null, function (result) {
        ...
        function getData() {
            //GET QUESTION
            apiService.get('ExerciseQ/' + 'ExF59F91E1-195E-402C', null, function (result) {
                $scope.curDataFilter = [];
            ...
            //GET ALL ANSWER
            apiService.get('StudentsAnswer/GetExerciseAnswer/' + 'ExF59F91E1-195E-402C', null, function (result) {
                $scope.answerData2 = [];
